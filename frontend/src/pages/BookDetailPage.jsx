...
const BookDetailPage = () => {
  ...
  const handleDelete  = async  () =>{
      ...
      try{
        ...
        console.erorr("Error deleting book",error);
        ...
        <div className='card bg-base-100 shadow-lg'>
          <div className='card-body'>
            ...
            <div className='form-control mb-4'>
              <label htmlFor="" className='label'><span className='label-text'>Title</span></label>
            ...
            <div className='form-control mb-6'>
              <label htmlFor="" className='label'><span className='label-text'>Publish Year</span></label>
